...
NOMBRE_SERVICIO = os.environ.get("NOMBRE_SERVICIO", "servicio-negocios")
...
SERVICIO_PUERTO = int(os.environ.get("SERVICIO_PUERTO", "8002"))
...
# --- Base de datos ---
# dev (docker-compose): Postgres compartido -> DATABASE_URL=postgres://.../negocios_db
