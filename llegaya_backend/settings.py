...
# ── HU14: Distribución de ingresos ────────────────────────
# % del monto total que se reserva para el repartidor en cada pago.
# La comisión de la plataforma, en cambio, es por negocio (Negocio.comision_porcentaje).
